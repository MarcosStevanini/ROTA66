...
import * as S from './oseias.styles';
import * as T from './oseias.types';

const Oseias: React.FC<T.OseiasProps> = () => {
    ...
    <>
      {animationDuration ? (
        ...
        >
          ...
          <S.Header>
            <S.TitleHeader>Oséias</S.TitleHeader>
          ...
          <S.Container>
            <S.CardChapter onPress={() => navigator.navigate('Ose339')}>
              <S.Number>339</S.Number>
            </S.CardChapter>

            <S.CardChapter onPress={() => navigator.navigate('Ose340')}>
              <S.Number>340</S.Number>
            </S.CardChapter>

            <S.CardChapter onPress={() => navigator.navigate('Ose341')}>
              <S.Number>341</S.Number>
            </S.CardChapter>

            <S.CardChapter onPress={() => navigator.navigate('Ose342')}>
              <S.Number>342</S.Number>
            </S.CardChapter>
