...
import * as S from './lv81.styles';
import * as T from './lv81.types';

const Lv81: React.FC<T.Lv81Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv81Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv81Props>('audios')
      .where('estudo', '==', 'Estudo 81')
      .onSnapshot(snapshot => {
