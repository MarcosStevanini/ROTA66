...
import * as S from './lv77.styles';
import * as T from './lv77.types';

const Lv77: React.FC<T.Lv77Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv77Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv77Props>('audios')
      .where('estudo', '==', 'Estudo 77')
      .onSnapshot(snapshot => {
