...
import * as S from './lv79.styles';
import * as T from './lv79.types';

const Lv79: React.FC<T.Lv79Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv79Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv79Props>('audios')
      .where('estudo', '==', 'Estudo 79')
      .onSnapshot(snapshot => {
