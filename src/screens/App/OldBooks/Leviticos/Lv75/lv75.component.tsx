...
import * as S from './lv75.styles';
import * as T from './lv75.types';

const Lv75: React.FC<T.Lv75Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv75Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv75Props>('audios')
      .where('estudo', '==', 'Estudo 75')
      .onSnapshot(snapshot => {
