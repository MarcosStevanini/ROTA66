...
import * as S from './lv85.styles';
import * as T from './lv85.types';

const Lv85: React.FC<T.Lv85Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv85Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv85Props>('audios')
      .where('estudo', '==', 'Estudo 85')
      .onSnapshot(snapshot => {
