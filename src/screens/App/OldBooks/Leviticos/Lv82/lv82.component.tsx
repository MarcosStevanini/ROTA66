...
import * as S from './lv82.styles';
import * as T from './lv82.types';

const Lv82: React.FC<T.Lv82Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv82Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv82Props>('audios')
      .where('estudo', '==', 'Estudo 82')
      .onSnapshot(snapshot => {
