...
import * as S from './lv76.styles';
import * as T from './lv76.types';

const Lv76: React.FC<T.Lv76Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv76Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv76Props>('audios')
      .where('estudo', '==', 'Estudo 76')
      .onSnapshot(snapshot => {
