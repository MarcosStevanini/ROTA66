...
import * as S from './lv83.styles';
import * as T from './lv83.types';

const Lv83: React.FC<T.Lv83Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv83Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv83Props>('audios')
      .where('estudo', '==', 'Estudo 83')
      .onSnapshot(snapshot => {
