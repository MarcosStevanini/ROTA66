...
import * as S from './lv80.styles';
import * as T from './lv80.types';

const Lv80: React.FC<T.Lv80Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv80Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv80Props>('audios')
      .where('estudo', '==', 'Estudo 80')
      .onSnapshot(snapshot => {
