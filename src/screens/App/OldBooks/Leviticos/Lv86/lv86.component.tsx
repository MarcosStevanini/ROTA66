...
import * as S from './lv86.styles';
import * as T from './lv86.types';

const Lv86: React.FC<T.Lv86Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv86Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv86Props>('audios')
      .where('estudo', '==', 'Estudo 86')
      .onSnapshot(snapshot => {
