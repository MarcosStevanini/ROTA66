...
import * as S from './lv78.styles';
import * as T from './lv78.types';

const Lv78: React.FC<T.Lv78Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv78Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv78Props>('audios')
      .where('estudo', '==', 'Estudo 78')
      .onSnapshot(snapshot => {
