...
import * as S from './lv84.styles';
import * as T from './lv84.types';

const Lv84: React.FC<T.Lv84Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Lv84Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Lv84Props>('audios')
      .where('estudo', '==', 'Estudo 84')
      .onSnapshot(snapshot => {
