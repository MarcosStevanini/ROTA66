...
import * as S from './segundo-cr331.styles';
import * as T from './segundo-cr331.types';

const SegundoCr331: React.FC<T.SegundoCr331Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCr331Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCr331Props>('audios')
      .where('estudo', '==', 'Estudo 331')
      .onSnapshot(snapshot => {
