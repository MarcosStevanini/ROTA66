...
import * as S from './segundo-cr329.styles';
import * as T from './segundo-cr329.types';

const SegundoCr329: React.FC<T.SegundoCr329Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCr329Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCr329Props>('audios')
      .where('estudo', '==', 'Estudo 329')
      .onSnapshot(snapshot => {
