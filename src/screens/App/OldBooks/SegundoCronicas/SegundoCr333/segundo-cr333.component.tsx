...
import * as S from './segundo-cr333.styles';
import * as T from './segundo-cr333.types';

const SegundoCr333: React.FC<T.SegundoCr333Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCr333Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCr333Props>('audios')
      .where('estudo', '==', 'Estudo 333')
      .onSnapshot(snapshot => {
