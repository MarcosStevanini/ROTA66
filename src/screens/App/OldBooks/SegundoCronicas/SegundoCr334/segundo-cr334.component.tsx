...
import * as S from './segundo-cr334.styles';
import * as T from './segundo-cr334.types';

const SegundoCr334: React.FC<T.SegundoCr334Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCr334Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCr334Props>('audios')
      .where('estudo', '==', 'Estudo 334')
      .onSnapshot(snapshot => {
