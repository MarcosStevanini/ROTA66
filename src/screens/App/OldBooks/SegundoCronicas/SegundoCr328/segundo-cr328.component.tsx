...
import * as S from './segundo-cr328.styles';
import * as T from './segundo-cr328.types';

const SegundoCr328: React.FC<T.SegundoCr328Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCr328Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCr328Props>('audios')
      .where('estudo', '==', 'Estudo 328')
      .onSnapshot(snapshot => {
