...
import * as S from './segundo-cr330.styles';
import * as T from './segundo-cr330.types';

const SegundoCr330: React.FC<T.SegundoCr330Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCr330Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCr330Props>('audios')
      .where('estudo', '==', 'Estudo 330')
      .onSnapshot(snapshot => {
