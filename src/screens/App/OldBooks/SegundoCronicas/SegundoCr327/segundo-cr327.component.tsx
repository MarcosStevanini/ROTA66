...
import * as S from './segundo-cr327.styles';
import * as T from './segundo-cr327.types';

const SegundoCr327: React.FC<T.SegundoCr327Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCr327Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCr327Props>('audios')
      .where('estudo', '==', 'Estudo 327')
      .onSnapshot(snapshot => {
