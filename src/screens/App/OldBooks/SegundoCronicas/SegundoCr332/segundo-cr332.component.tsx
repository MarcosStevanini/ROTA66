...
import * as S from './segundo-cr332.styles';
import * as T from './segundo-cr332.types';

const SegundoCr332: React.FC<T.SegundoCr332Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCr332Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCr332Props>('audios')
      .where('estudo', '==', 'Estudo 332')
      .onSnapshot(snapshot => {
