...
import * as S from './gl118.styles';
import * as T from './gl118.types';

const Gl118: React.FC<T.Gl118Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gl118Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gl118Props>('audios')
      .where('estudo', '==', 'Estudo 118')
      .onSnapshot(snapshot => {
