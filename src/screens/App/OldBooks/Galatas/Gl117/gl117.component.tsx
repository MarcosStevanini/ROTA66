...
import * as S from './gl117.styles';
import * as T from './gl117.types';

const Gl117: React.FC<T.Gl117Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gl117Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gl117Props>('audios')
      .where('estudo', '==', 'Estudo 117')
      .onSnapshot(snapshot => {
