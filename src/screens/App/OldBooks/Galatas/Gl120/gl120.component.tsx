...
import * as S from './gl120.styles';
import * as T from './gl120.types';

const Gl120: React.FC<T.Gl120Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gl120Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gl120Props>('audios')
      .where('estudo', '==', 'Estudo 120')
      .onSnapshot(snapshot => {
