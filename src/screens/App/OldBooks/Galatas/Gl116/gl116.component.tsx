...
import * as S from './gl116.styles';
import * as T from './gl116.types';

const Gl116: React.FC<T.Gl116Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gl116Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gl116Props>('audios')
      .where('estudo', '==', 'Estudo 116')
      .onSnapshot(snapshot => {
