...
import * as S from './gl115.styles';
import * as T from './gl115.types';

const Gl115: React.FC<T.Gl115Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gl115Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gl115Props>('audios')
      .where('estudo', '==', 'Estudo 115')
      .onSnapshot(snapshot => {
