...
import * as S from './primeiro-sam186.styles';
import * as T from './primeiro-sam186.types';

const PrimeiroSam186: React.FC<T.PrimeiroSam186Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam186Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam186Props>('audios')
      .where('estudo', '==', 'Estudo 186')
      .onSnapshot(snapshot => {
