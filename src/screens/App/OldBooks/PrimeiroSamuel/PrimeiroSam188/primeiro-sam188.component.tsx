...
import * as S from './primeiro-sam188.styles';
import * as T from './primeiro-sam188.types';

const PrimeiroSam188: React.FC<T.PrimeiroSam188Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam188Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam188Props>('audios')
      .where('estudo', '==', 'Estudo 188')
      .onSnapshot(snapshot => {
