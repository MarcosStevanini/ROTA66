...
import * as S from './primeiro-sam191.styles';
import * as T from './primeiro-sam191.types';

const PrimeiroSam191: React.FC<T.PrimeiroSam191Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam191Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam191Props>('audios')
      .where('estudo', '==', 'Estudo 191')
      .onSnapshot(snapshot => {
