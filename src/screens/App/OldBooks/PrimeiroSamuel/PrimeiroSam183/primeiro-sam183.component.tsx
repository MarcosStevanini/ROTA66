...
import * as S from './primeiro-sam183.styles';
import * as T from './primeiro-sam183.types';

const PrimeiroSam183: React.FC<T.PrimeiroSam183Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam183Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam183Props>('audios')
      .where('estudo', '==', 'Estudo 183')
      .onSnapshot(snapshot => {
