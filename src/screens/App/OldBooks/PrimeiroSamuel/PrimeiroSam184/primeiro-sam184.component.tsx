...
import * as S from './primeiro-sam184.styles';
import * as T from './primeiro-sam184.types';

const PrimeiroSam184: React.FC<T.PrimeiroSam184Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam184Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam184Props>('audios')
      .where('estudo', '==', 'Estudo 184')
      .onSnapshot(snapshot => {
