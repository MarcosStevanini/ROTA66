...
import * as S from './primeiro-sam182.styles';
import * as T from './primeiro-sam182.types';

const PrimeiroSam182: React.FC<T.PrimeiroSam182Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam182Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam182Props>('audios')
      .where('estudo', '==', 'Estudo 182')
      .onSnapshot(snapshot => {
