...
import * as S from './primeiro-sam175.styles';
import * as T from './primeiro-sam175.types';

const PrimeiroSam175: React.FC<T.PrimeiroSam175Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam175Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam175Props>('audios')
      .where('estudo', '==', 'Estudo 175')
      .onSnapshot(snapshot => {
