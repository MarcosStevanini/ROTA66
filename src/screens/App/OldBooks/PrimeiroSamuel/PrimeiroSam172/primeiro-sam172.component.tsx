...
import * as S from './primeiro-sam172.styles';
import * as T from './primeiro-sam172.types';

const PrimeiroSam172: React.FC<T.PrimeiroSam172Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam172Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam172Props>('audios')
      .where('estudo', '==', 'Estudo 172')
      .onSnapshot(snapshot => {
