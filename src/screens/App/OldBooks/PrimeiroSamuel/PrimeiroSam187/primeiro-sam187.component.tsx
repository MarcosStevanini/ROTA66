...
import * as S from './primeiro-sam187.styles';
import * as T from './primeiro-sam187.types';

const PrimeiroSam187: React.FC<T.PrimeiroSam187Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam187Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam187Props>('audios')
      .where('estudo', '==', 'Estudo 187')
      .onSnapshot(snapshot => {
