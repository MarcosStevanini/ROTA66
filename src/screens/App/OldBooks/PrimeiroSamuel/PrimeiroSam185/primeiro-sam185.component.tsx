...
import * as S from './primeiro-sam185.styles';
import * as T from './primeiro-sam185.types';

const PrimeiroSam185: React.FC<T.PrimeiroSam185Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam185Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam185Props>('audios')
      .where('estudo', '==', 'Estudo 185')
      .onSnapshot(snapshot => {
