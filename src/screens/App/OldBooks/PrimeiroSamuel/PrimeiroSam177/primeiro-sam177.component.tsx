...
import * as S from './primeiro-sam177.styles';
import * as T from './primeiro-sam177.types';

const PrimeiroSam177: React.FC<T.PrimeiroSam177Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam177Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam177Props>('audios')
      .where('estudo', '==', 'Estudo 177')
      .onSnapshot(snapshot => {
