...
import * as S from './primeiro-sam180.styles';
import * as T from './primeiro-sam180.types';

const PrimeiroSam180: React.FC<T.PrimeiroSam180Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam180Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam180Props>('audios')
      .where('estudo', '==', 'Estudo 180')
      .onSnapshot(snapshot => {
