...
import * as S from './primeiro-sam176.styles';
import * as T from './primeiro-sam176.types';

const PrimeiroSam176: React.FC<T.PrimeiroSam176Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam176Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam176Props>('audios')
      .where('estudo', '==', 'Estudo 176')
      .onSnapshot(snapshot => {
