...
import * as S from './primeiro-sam190.styles';
import * as T from './primeiro-sam190.types';

const PrimeiroSam190: React.FC<T.PrimeiroSam190Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam190Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam190Props>('audios')
      .where('estudo', '==', 'Estudo 190')
      .onSnapshot(snapshot => {
