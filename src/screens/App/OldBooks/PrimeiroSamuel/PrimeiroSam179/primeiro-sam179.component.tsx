...
import * as S from './primeiro-sam179.styles';
import * as T from './primeiro-sam179.types';

const PrimeiroSam179: React.FC<T.PrimeiroSam179Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam179Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam179Props>('audios')
      .where('estudo', '==', 'Estudo 179')
      .onSnapshot(snapshot => {
