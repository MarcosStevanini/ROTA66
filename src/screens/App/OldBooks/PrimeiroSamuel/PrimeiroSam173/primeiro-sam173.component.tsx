...
import * as S from './primeiro-sam173.styles';
import * as T from './primeiro-sam173.types';

const PrimeiroSam173: React.FC<T.PrimeiroSam173Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam173Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam173Props>('audios')
      .where('estudo', '==', 'Estudo 173')
      .onSnapshot(snapshot => {
