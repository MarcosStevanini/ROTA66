...
import * as S from './primeiro-sam174.styles';
import * as T from './primeiro-sam174.types';

const PrimeiroSam174: React.FC<T.PrimeiroSam174Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam174Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam174Props>('audios')
      .where('estudo', '==', 'Estudo 174')
      .onSnapshot(snapshot => {
