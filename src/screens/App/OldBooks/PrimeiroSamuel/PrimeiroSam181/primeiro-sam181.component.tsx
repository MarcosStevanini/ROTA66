...
import * as S from './primeiro-sam181.styles';
import * as T from './primeiro-sam181.types';

const PrimeiroSam181: React.FC<T.PrimeiroSam181Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam181Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam181Props>('audios')
      .where('estudo', '==', 'Estudo 181')
      .onSnapshot(snapshot => {
