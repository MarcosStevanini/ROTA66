...
import * as S from './primeiro-sam178.styles';
import * as T from './primeiro-sam178.types';

const PrimeiroSam178: React.FC<T.PrimeiroSam178Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam178Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam178Props>('audios')
      .where('estudo', '==', 'Estudo 178')
      .onSnapshot(snapshot => {
