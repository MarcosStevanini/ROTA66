...
import * as S from './primeiro-sam189.styles';
import * as T from './primeiro-sam189.types';

const PrimeiroSam189: React.FC<T.PrimeiroSam189Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroSam189Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroSam189Props>('audios')
      .where('estudo', '==', 'Estudo 189')
      .onSnapshot(snapshot => {
