...
import * as S from './ex54.styles';
import * as T from './ex54.types';

const Ex54: React.FC<T.Ex54Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex54Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex54Props>('audios')
      .where('estudo', '==', 'Estudo 54')
      .onSnapshot(snapshot => {
