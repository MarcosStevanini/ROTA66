...
import * as S from './ex51.styles';
import * as T from './ex51.types';

const Ex51: React.FC<T.Ex51Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex51Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex51Props>('audios')
      .where('estudo', '==', 'Estudo 51')
      .onSnapshot(snapshot => {
