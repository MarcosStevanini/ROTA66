...
import * as S from './ex59.styles'
import * as T from './ex59.types'

const Ex59: React.FC<T.Ex59Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex59Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex59Props>('audios')
      .where('estudo', '==', 'Estudo 59')
      .onSnapshot(snapshot => {
