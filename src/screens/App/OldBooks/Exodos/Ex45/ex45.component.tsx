...
import * as S from './ex45.styles';
import * as T from './ex45.types';

const Ex45: React.FC<T.Ex45Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex45Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex45Props>('audios')
      .where('estudo', '==', 'Estudo 45')
      .onSnapshot(snapshot => {
