...
import * as S from './ex52.styles';
import * as T from './ex52.types';

const Ex52: React.FC<T.Ex52Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex52Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex52Props>('audios')
      .where('estudo', '==', 'Estudo 52')
      .onSnapshot(snapshot => {
