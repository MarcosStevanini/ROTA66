...
import * as S from './ex44.styles';
import * as T from './ex44.types';

const Ex44: React.FC<T.Ex44Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex44Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex44Props>('audios')
      .where('estudo', '==', 'Estudo 44')
      .onSnapshot(snapshot => {
