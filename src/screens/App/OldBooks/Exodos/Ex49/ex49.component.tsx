...
import * as S from './ex49.styles';
import * as T from './ex49.types';

const Ex49: React.FC<T.Ex49Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex49Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex49Props>('audios')
      .where('estudo', '==', 'Estudo 49')
      .onSnapshot(snapshot => {
