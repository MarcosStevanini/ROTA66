...
import * as S from './ex48.styles';
import * as T from './ex48.types';

const Ex48: React.FC<T.Ex48Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex48Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex48Props>('audios')
      .where('estudo', '==', 'Estudo 48')
      .onSnapshot(snapshot => {
