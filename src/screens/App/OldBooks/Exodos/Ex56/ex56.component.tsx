...
import * as S from './ex56.styles';
import * as T from './ex56.types';

const Ex56: React.FC<T.Ex56Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex56Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex56Props>('audios')
      .where('estudo', '==', 'Estudo 56')
      .onSnapshot(snapshot => {
