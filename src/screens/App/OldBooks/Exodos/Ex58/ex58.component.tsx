...
import * as S from './ex58.styles';
import * as T from './ex58.types';

const Ex58: React.FC<T.Ex58Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex58Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex58Props>('audios')
      .where('estudo', '==', 'Estudo 58')
      .onSnapshot(snapshot => {
