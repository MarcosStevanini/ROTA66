...
import * as S from './ex60.styles';
import * as T from './ex60.types';

const Ex60: React.FC<T.Ex60Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex60Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex60Props>('audios')
      .where('estudo', '==', 'Estudo 60')
      .onSnapshot(snapshot => {
