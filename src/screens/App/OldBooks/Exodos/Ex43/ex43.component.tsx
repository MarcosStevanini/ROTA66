...
import * as S from './ex43.styles';
import * as T from './ex43.types';

const Ex43: React.FC<T.Ex43Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex43Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex43Props>('audios')
      .where('estudo', '==', 'Estudo 43')
      .onSnapshot(snapshot => {
