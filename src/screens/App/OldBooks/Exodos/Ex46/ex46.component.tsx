...
import * as S from './ex46.styles';
import * as T from './ex46.types';

const Ex46: React.FC<T.Ex46Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex46Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex46Props>('audios')
      .where('estudo', '==', 'Estudo 46')
      .onSnapshot(snapshot => {
