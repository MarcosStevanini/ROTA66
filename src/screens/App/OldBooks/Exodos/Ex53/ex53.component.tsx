...
import * as S from './ex53.styles';
import * as T from './ex53.types';

const Ex53: React.FC<T.Ex53Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex53Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex53Props>('audios')
      .where('estudo', '==', 'Estudo 53')
      .onSnapshot(snapshot => {
