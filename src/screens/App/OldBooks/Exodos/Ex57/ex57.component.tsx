...
import * as S from './ex57.styles';
import * as T from './ex57.types';

const Ex57: React.FC<T.Ex57Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex57Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex57Props>('audios')
      .where('estudo', '==', 'Estudo 57')
      .onSnapshot(snapshot => {
