...
import * as S from './ex47.styles';
import * as T from './ex47.types';

const Ex47: React.FC<T.Ex47Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex47Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex47Props>('audios')
      .where('estudo', '==', 'Estudo 47')
      .onSnapshot(snapshot => {
