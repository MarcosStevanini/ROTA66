...
import * as S from './ex55.styles';
import * as T from './ex55.types';

const Ex55: React.FC<T.Ex55Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex55Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex55Props>('audios')
      .where('estudo', '==', 'Estudo 55')
      .onSnapshot(snapshot => {
