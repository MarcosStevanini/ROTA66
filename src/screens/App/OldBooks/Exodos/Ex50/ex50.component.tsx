...
import * as S from './ex50.styles';
import * as T from './ex50.types';

const Ex50: React.FC<T.Ex50Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Ex50Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Ex50Props>('audios')
      .where('estudo', '==', 'Estudo 50')
      .onSnapshot(snapshot => {
