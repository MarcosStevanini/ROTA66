...
import * as S from './tg143.styles';
import * as T from './tg143.types';

const Tg143: React.FC<T.Tg143Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Tg143Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Tg143Props>('audios')
      .where('estudo', '==', 'Estudo 143')
      .onSnapshot(snapshot => {
