...
import * as S from './tg141.styles';
import * as T from './tg141.types';

const Tg141: React.FC<T.Tg141Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Tg141Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Tg141Props>('audios')
      .where('estudo', '==', 'Estudo 141')
      .onSnapshot(snapshot => {
