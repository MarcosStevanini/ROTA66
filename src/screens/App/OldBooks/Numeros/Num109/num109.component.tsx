...
import * as S from './num109.styles';
import * as T from './num109.types';

const Num109: React.FC<T.Num109Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num109Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num109Props>('audios')
      .where('estudo', '==', 'Estudo 109')
      .onSnapshot(snapshot => {
