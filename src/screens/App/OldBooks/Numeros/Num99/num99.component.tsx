...
import * as S from './num99.styles';
import * as T from './num99.types';

const Num99: React.FC<T.Num99Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num99Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num99Props>('audios')
      .where('estudo', '==', 'Estudo 99')
      .onSnapshot(snapshot => {
