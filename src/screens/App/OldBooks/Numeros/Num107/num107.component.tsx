...
import * as S from './num107.styles';
import * as T from './num107.types';

const Num107: React.FC<T.Num107Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num107Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num107Props>('audios')
      .where('estudo', '==', 'Estudo 107')
      .onSnapshot(snapshot => {
