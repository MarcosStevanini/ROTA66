...
import * as S from './num103.styles';
import * as T from './num103.types';

const Num103: React.FC<T.Num103Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num103Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num103Props>('audios')
      .where('estudo', '==', 'Estudo 103')
      .onSnapshot(snapshot => {
