...
import * as S from './num108.styles';
import * as T from './num108.types';

const Num108: React.FC<T.Num108Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num108Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num108Props>('audios')
      .where('estudo', '==', 'Estudo 108')
      .onSnapshot(snapshot => {
