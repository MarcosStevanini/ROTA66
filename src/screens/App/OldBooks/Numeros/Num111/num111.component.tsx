...
import * as S from './num111.styles';
import * as T from './num111.types';

const Num111: React.FC<T.Num111Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num111Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num111Props>('audios')
      .where('estudo', '==', 'Estudo 111')
      .onSnapshot(snapshot => {
