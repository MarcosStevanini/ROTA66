...
import * as S from './num113.styles';
import * as T from './num113.types';

const Num113: React.FC<T.Num113Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num113Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num113Props>('audios')
      .where('estudo', '==', 'Estudo 113')
      .onSnapshot(snapshot => {
