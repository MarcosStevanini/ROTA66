...
import * as S from './num112.styles';
import * as T from './num112.types';

const Num112: React.FC<T.Num112Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num112Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num112Props>('audios')
      .where('estudo', '==', 'Estudo 112')
      .onSnapshot(snapshot => {
