...
import * as S from './num110.styles';
import * as T from './num110.types';

const Num110: React.FC<T.Num110Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num110Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num110Props>('audios')
      .where('estudo', '==', 'Estudo 110')
      .onSnapshot(snapshot => {
