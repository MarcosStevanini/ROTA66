...
import * as S from './num100.styles';
import * as T from './num100.types';

const Num100: React.FC<T.Num100Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num100Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num100Props>('audios')
      .where('estudo', '==', 'Estudo 100')
      .onSnapshot(snapshot => {
