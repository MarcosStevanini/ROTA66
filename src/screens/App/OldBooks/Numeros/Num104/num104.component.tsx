...
import * as S from './num104.styles';
import * as T from './num104.types';

const Num104: React.FC<T.Num104Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num104Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num104Props>('audios')
      .where('estudo', '==', 'Estudo 104')
      .onSnapshot(snapshot => {
