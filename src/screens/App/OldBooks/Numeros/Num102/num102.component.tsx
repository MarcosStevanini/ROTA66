...
import * as S from './num102.styles';
import * as T from './num102.types';

const Num102: React.FC<T.Num102Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num102Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num102Props>('audios')
      .where('estudo', '==', 'Estudo 102')
      .onSnapshot(snapshot => {
