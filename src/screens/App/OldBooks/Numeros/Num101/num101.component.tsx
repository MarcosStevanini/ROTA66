...
import * as S from './num101.styles';
import * as T from './num101.types';

const Num101: React.FC<T.Num101Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num101Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num101Props>('audios')
      .where('estudo', '==', 'Estudo 101')
      .onSnapshot(snapshot => {
