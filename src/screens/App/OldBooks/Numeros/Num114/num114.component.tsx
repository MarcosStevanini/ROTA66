...
import * as S from './num114.styles';
import * as T from './num114.types';

const Num114: React.FC<T.Num114Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num114Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num114Props>('audios')
      .where('estudo', '==', 'Estudo 114')
      .onSnapshot(snapshot => {
