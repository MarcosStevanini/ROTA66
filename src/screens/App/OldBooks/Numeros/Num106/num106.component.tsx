...
import * as S from './num106.styles';
import * as T from './num106.types';

const Num106: React.FC<T.Num106Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num106Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num106Props>('audios')
      .where('estudo', '==', 'Estudo 106')
      .onSnapshot(snapshot => {
