...
import * as S from './num105.styles';
import * as T from './num105.types';

const Num105: React.FC<T.Num105Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Num105Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Num105Props>('audios')
      .where('estudo', '==', 'Estudo 105')
      .onSnapshot(snapshot => {
