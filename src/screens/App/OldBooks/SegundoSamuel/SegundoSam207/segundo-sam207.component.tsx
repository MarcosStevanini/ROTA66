...
import * as S from './segundo-sam207.styles';
import * as T from './segundo-sam207.types';

const SegundoSam207: React.FC<T.SegundoSam207Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam207Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam207Props>('audios')
      .where('estudo', '==', 'Estudo 207')
      .onSnapshot(snapshot => {
