...
import * as S from './segundo-sam192.styles';
import * as T from './segundo-sam192.types';

const SegundoSam192: React.FC<T.SegundoSam192Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam192Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam192Props>('audios')
      .where('estudo', '==', 'Estudo 192')
      .onSnapshot(snapshot => {
