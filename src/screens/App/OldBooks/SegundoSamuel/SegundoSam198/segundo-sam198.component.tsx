...
import * as S from './segundo-sam198.styles';
import * as T from './segundo-sam198.types';

const SegundoSam198: React.FC<T.SegundoSam198Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam198Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam198Props>('audios')
      .where('estudo', '==', 'Estudo 198')
      .onSnapshot(snapshot => {
