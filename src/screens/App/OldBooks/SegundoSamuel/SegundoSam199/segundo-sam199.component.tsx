...
import * as S from './segundo-sam199.styles';
import * as T from './segundo-sam199.types';

const SegundoSam199: React.FC<T.SegundoSam199Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam199Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam199Props>('audios')
      .where('estudo', '==', 'Estudo 199')
      .onSnapshot(snapshot => {
