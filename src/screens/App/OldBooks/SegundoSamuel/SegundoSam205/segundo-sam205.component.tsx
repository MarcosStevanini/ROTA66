...
import * as S from './segundo-sam205.styles';
import * as T from './segundo-sam205.types';

const SegundoSam205: React.FC<T.SegundoSam205Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam205Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam205Props>('audios')
      .where('estudo', '==', 'Estudo 205')
      .onSnapshot(snapshot => {
