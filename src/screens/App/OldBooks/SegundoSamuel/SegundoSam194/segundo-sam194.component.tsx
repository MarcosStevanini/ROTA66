...
import * as S from './segundo-sam194.styles';
import * as T from './segundo-sam194.types';

const SegundoSam194: React.FC<T.SegundoSam194Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam194Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam194Props>('audios')
      .where('estudo', '==', 'Estudo 194')
      .onSnapshot(snapshot => {
