...
import * as S from './segundo-sam202.styles';
import * as T from './segundo-sam202.types';

const SegundoSam202: React.FC<T.SegundoSam202Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam202Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam202Props>('audios')
      .where('estudo', '==', 'Estudo 202')
      .onSnapshot(snapshot => {
