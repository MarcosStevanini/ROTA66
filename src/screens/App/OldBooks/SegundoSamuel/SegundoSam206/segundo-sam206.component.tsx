...
import * as S from './segundo-sam206.styles';
import * as T from './segundo-sam206.types';

const SegundoSam206: React.FC<T.SegundoSam206Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam206Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam206Props>('audios')
      .where('estudo', '==', 'Estudo 206')
      .onSnapshot(snapshot => {
