...
import * as S from './segundo-sam200.styles';
import * as T from './segundo-sam200.types';

const SegundoSam200: React.FC<T.SegundoSam200Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam200Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam200Props>('audios')
      .where('estudo', '==', 'Estudo 200')
      .onSnapshot(snapshot => {
