...
import * as S from './segundo-sam204.styles';
import * as T from './segundo-sam204.types';

const SegundoSam204: React.FC<T.SegundoSam204Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam204Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam204Props>('audios')
      .where('estudo', '==', 'Estudo 204')
      .onSnapshot(snapshot => {
