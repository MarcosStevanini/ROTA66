...
import * as S from './segundo-sam196.styles';
import * as T from './segundo-sam196.types';

const SegundoSam196: React.FC<T.SegundoSam196Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam196Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam196Props>('audios')
      .where('estudo', '==', 'Estudo 196')
      .onSnapshot(snapshot => {
