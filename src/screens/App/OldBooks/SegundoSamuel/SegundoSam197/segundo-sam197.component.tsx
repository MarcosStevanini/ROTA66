...
import * as S from './segundo-sam197.styles';
import * as T from './segundo-sam197.types';

const SegundoSam197: React.FC<T.SegundoSam197Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam197Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam197Props>('audios')
      .where('estudo', '==', 'Estudo 197')
      .onSnapshot(snapshot => {
