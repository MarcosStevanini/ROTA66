...
import * as S from './segundo-sam201.styles';
import * as T from './segundo-sam201.types';

const SegundoSam201: React.FC<T.SegundoSam201Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam201Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam201Props>('audios')
      .where('estudo', '==', 'Estudo 201')
      .onSnapshot(snapshot => {
