...
import * as S from './segundo-sam193.styles';
import * as T from './segundo-sam193.types';

const SegundoSam193: React.FC<T.SegundoSam193Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam193Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam193Props>('audios')
      .where('estudo', '==', 'Estudo 193')
      .onSnapshot(snapshot => {
