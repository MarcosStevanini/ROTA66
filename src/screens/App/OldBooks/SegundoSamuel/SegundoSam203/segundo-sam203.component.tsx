...
import * as S from './segundo-sam203.styles';
import * as T from './segundo-sam203.types';

const SegundoSam203: React.FC<T.SegundoSam203Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam203Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam203Props>('audios')
      .where('estudo', '==', 'Estudo 203')
      .onSnapshot(snapshot => {
