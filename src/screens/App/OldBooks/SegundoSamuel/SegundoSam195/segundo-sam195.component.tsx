...
import * as S from './segundo-sam195.styles';
import * as T from './segundo-sam195.types';

const SegundoSam195: React.FC<T.SegundoSam195Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoSam195Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoSam195Props>('audios')
      .where('estudo', '==', 'Estudo 195')
      .onSnapshot(snapshot => {
