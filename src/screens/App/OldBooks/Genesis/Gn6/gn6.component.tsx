...
import * as S from './gn6.styles'
import * as T from './gn6.types'

const Gn6: React.FC<T.Gn6Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn6Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn6Props>('audios')
      .where('estudo', '==', 'Estudo 6')
      .onSnapshot(snapshot => {
