...
import * as S from './gn3.styles'
import * as T from './gn3.types'

const Gn3: React.FC<T.Gn3Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn3Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn3Props>('audios')
      .where('estudo', '==', 'Estudo 3')
      .onSnapshot(snapshot => {
