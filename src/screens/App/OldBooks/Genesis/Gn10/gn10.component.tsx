...
import * as S from './gn10.styles'
import * as T from './gn10.types'

const Gn10: React.FC<T.Gn10Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn10Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn10Props>('audios')
      .where('estudo', '==', 'Estudo 10')
      .onSnapshot(snapshot => {
