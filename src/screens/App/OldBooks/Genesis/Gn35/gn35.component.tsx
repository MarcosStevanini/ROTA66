...
import * as S from './gn35.styles';
import * as T from './gn35.types';

const Gn35: React.FC<T.Gn35Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn35Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn35Props>('audios')
      .where('estudo', '==', 'Estudo 35')
      .onSnapshot(snapshot => {
