...
import * as S from './gn31.styles';
import * as T from './gn31.types';

const Gn31: React.FC<T.Gn31Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn31Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn31Props>('audios')
      .where('estudo', '==', 'Estudo 31')
      .onSnapshot(snapshot => {
