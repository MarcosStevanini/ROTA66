...
import * as S from './gn29.styles'
import * as T from './gn29.types'

const Gn29: React.FC<T.Gn29Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn29Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn29Props>('audios')
      .where('estudo', '==', 'Estudo 29')
      .onSnapshot(snapshot => {
