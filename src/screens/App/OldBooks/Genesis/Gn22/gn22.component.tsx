...
import * as S from './gn22.styles';
import * as T from './gn22.types';

const Gn22: React.FC<T.Gn22Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn22Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn22Props>('audios')
      .where('estudo', '==', 'Estudo 22')
      .onSnapshot(snapshot => {
