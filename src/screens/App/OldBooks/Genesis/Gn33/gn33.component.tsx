...
import * as S from './gn33.styles';
import * as T from './gn33.types';

const Gn33: React.FC<T.Gn33Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn33Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn33Props>('audios')
      .where('estudo', '==', 'Estudo 33')
      .onSnapshot(snapshot => {
