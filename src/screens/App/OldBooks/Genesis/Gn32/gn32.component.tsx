...
import * as S from './gn32.styles'
import * as T from './gn32.types'

const Gn32: React.FC<T.Gn32Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn32Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn32Props>('audios')
      .where('estudo', '==', 'Estudo 32')
      .onSnapshot(snapshot => {
