...
import * as S from './gn21.styles'
import * as T from './gn21.types'

const Gn21: React.FC<T.Gn21Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn21Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn21Props>('audios')
      .where('estudo', '==', 'Estudo 21')
      .onSnapshot(snapshot => {
