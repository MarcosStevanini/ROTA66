...
import * as S from './gn9.styles'
import * as T from './gn9.types'

const Gn9: React.FC<T.Gn9Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn9Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn9Props>('audios')
      .where('estudo', '==', 'Estudo 9')
      .onSnapshot(snapshot => {
