...
import * as S from './gn38.styles';
import * as T from './gn38.types';

const Gn38: React.FC<T.Gn38Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn38Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn38Props>('audios')
      .where('estudo', '==', 'Estudo 38')
      .onSnapshot(snapshot => {
