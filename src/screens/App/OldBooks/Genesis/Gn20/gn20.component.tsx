...
import * as S from './gn20.styles'
import * as T from './gn20.types'

const Gn20: React.FC<T.Gn20Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn20Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn20Props>('audios')
      .where('estudo', '==', 'Estudo 20')
      .onSnapshot(snapshot => {
