...
import * as S from './gn14.styles'
import * as T from './gn14.types'

const Gn14: React.FC<T.Gn14Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn14Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn14Props>('audios')
      .where('estudo', '==', 'Estudo 14')
      .onSnapshot(snapshot => {
