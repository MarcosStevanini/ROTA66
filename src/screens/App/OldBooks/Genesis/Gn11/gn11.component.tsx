...
import * as S from './gn11.styles'
import * as T from './gn11.types'

const Gn11: React.FC<T.Gn11Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn11Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn11Props>('audios')
      .where('estudo', '==', 'Estudo 11')
      .onSnapshot(snapshot => {
