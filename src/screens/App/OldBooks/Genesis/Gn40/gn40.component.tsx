...
import * as S from './gn40.styles'
import * as T from './gn40.types'

const Gn40: React.FC<T.Gn40Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn40Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn40Props>('audios')
      .where('estudo', '==', 'Estudo 40')
      .onSnapshot(snapshot => {
