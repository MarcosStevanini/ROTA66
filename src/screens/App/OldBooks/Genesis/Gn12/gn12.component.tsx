...
import * as S from './gn12.styles';
import * as T from './gn12.types';

const Gn12: React.FC<T.Gn12Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn12Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn12Props>('audios')
      .where('estudo', '==', 'Estudo 12')
      .onSnapshot(snapshot => {
