...
import * as S from './gn27.styles'
import * as T from './gn27.types'

const Gn27: React.FC<T.Gn27Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn27Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn27Props>('audios')
      .where('estudo', '==', 'Estudo 27')
      .onSnapshot(snapshot => {
