...
import * as S from './gn42.styles'
import * as T from './gn42.types'

const Gn42: React.FC<T.Gn42Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn42Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn42Props>('audios')
      .where('estudo', '==', 'Estudo 42')
      .onSnapshot(snapshot => {
