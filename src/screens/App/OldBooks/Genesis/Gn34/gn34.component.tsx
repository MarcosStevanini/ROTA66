...
import * as S from './gn34.styles'
import * as T from './gn34.types'

const Gn34: React.FC<T.Gn34Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn34Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn34Props>('audios')
      .where('estudo', '==', 'Estudo 34')
      .onSnapshot(snapshot => {
