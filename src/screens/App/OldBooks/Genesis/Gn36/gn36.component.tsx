...
import * as S from './gn36.styles'
import * as T from './gn36.types'

const Gn36: React.FC<T.Gn36Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn36Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn36Props>('audios')
      .where('estudo', '==', 'Estudo 36')
      .onSnapshot(snapshot => {
