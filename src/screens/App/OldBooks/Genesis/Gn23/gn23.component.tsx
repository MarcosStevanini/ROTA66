...
import * as S from './gn23.styles';
import * as T from './gn23.types';

const Gn23: React.FC<T.Gn23Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn23Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn23Props>('audios')
      .where('estudo', '==', 'Estudo 23')
      .onSnapshot(snapshot => {
