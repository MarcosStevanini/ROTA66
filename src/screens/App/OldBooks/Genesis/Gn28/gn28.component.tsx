...
import * as S from './gn28.styles'
import * as T from './gn28.types'

const Gn28: React.FC<T.Gn28Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn28Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn28Props>('audios')
      .where('estudo', '==', 'Estudo 28')
      .onSnapshot(snapshot => {
