...
import * as S from './gn26.styles'
import * as T from './gn26.types'

const Gn26: React.FC<T.Gn26Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn26Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn26Props>('audios')
      .where('estudo', '==', 'Estudo 26')
      .onSnapshot(snapshot => {
