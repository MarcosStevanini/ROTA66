...
import * as S from './gn15.styles';
import * as T from './gn15.types';

const Gn15: React.FC<T.Gn15Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn15Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn15Props>('audios')
      .where('estudo', '==', 'Estudo 15')
      .onSnapshot(snapshot => {
