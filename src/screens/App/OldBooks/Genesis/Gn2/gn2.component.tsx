...
import * as S from './gn2.styles'
import * as T from './gn2.types'

const Gn2: React.FC<T.Gn2Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn2Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn2Props>('audios')
      .where('estudo', '==', 'Estudo 2')
      .onSnapshot(snapshot => {
