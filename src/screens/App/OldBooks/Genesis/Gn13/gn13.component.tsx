...
import * as S from './gn13.styles'
import * as T from './gn13.types'

const Gn13: React.FC<T.Gn13Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn13Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn13Props>('audios')
      .where('estudo', '==', 'Estudo 13')
      .onSnapshot(snapshot => {
