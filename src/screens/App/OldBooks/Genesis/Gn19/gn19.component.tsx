...
import * as S from './gn19.styles'
import * as T from './gn19.types'

const Gn19: React.FC<T.Gn19Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn19Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn19Props>('audios')
      .where('estudo', '==', 'Estudo 19')
      .onSnapshot(snapshot => {
