...
import * as S from './gn25.styles'
import * as T from './gn25.types'

const Gn25: React.FC<T.Gn25Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn25Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn25Props>('audios')
      .where('estudo', '==', 'Estudo 25')
      .onSnapshot(snapshot => {
