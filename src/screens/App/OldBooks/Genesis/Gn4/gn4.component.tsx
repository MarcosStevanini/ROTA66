...
import * as S from './gn4.styles'
import * as T from './gn4.types'

const Gn4: React.FC<T.Gn4Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn4Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn4Props>('audios')
      .where('estudo', '==', 'Estudo 4')
      .onSnapshot(snapshot => {
