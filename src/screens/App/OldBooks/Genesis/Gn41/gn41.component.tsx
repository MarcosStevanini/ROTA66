...
import * as S from './gn41.styles'
import * as T from './gn41.types'

const Gn41: React.FC<T.Gn41Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn41Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn41Props>('audios')
      .where('estudo', '==', 'Estudo 41')
      .onSnapshot(snapshot => {
