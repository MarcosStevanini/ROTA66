...
import * as S from './gn7.styles';
import * as T from './gn7.types';

const Gn7: React.FC<T.Gn7Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn7Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn7Props>('audios')
      .where('estudo', '==', 'Estudo 7')
      .onSnapshot(snapshot => {
