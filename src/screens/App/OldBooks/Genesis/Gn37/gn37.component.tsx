...
import * as S from './gn37.styles'
import * as T from './gn37.types'

const Gn37: React.FC<T.Gn37Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn37Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn37Props>('audios')
      .where('estudo', '==', 'Estudo 37')
      .onSnapshot(snapshot => {
