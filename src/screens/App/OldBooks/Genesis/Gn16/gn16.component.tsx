...
import * as S from './gn16.styles'
import * as T from './gn16.types'

const Gn16: React.FC<T.Gn16Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn16Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn16Props>('audios')
      .where('estudo', '==', 'Estudo 16')
      .onSnapshot(snapshot => {
