...
import * as S from './gn5.styles'
import * as T from './gn5.types'

const Gn5: React.FC<T.Gn5Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn5Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn5Props>('audios')
      .where('estudo', '==', 'Estudo 5')
      .onSnapshot(snapshot => {
