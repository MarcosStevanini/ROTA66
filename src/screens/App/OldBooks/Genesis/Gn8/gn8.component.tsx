...
import * as S from './gn8.styles'
import * as T from './gn8.types'

const Gn8: React.FC<T.Gn8Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn8Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn8Props>('audios')
      .where('estudo', '==', 'Estudo 8')
      .onSnapshot(snapshot => {
