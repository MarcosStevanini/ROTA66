...
import * as S from './gn24.styles'
import * as T from './gn24.types'

const Gn24: React.FC<T.Gn24Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn24Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn24Props>('audios')
      .where('estudo', '==', 'Estudo 24')
      .onSnapshot(snapshot => {
