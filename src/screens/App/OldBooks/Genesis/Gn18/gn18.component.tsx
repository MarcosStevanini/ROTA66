...
import * as S from './gn18.styles'
import * as T from './gn18.types'

const Gn18: React.FC<T.Gn18Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn18Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn18Props>('audios')
      .where('estudo', '==', 'Estudo 18')
      .onSnapshot(snapshot => {
