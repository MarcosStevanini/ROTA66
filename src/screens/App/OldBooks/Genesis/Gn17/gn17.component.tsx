...
import * as S from './gn17.styles'
import * as T from './gn17.types'

const Gn17: React.FC<T.Gn17Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gn17Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gn17Props>('audios')
      .where('estudo', '==', 'Estudo 17')
      .onSnapshot(snapshot => {
