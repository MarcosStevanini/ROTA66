...
import * as S from './primeiro-cr326.styles';
import * as T from './primeiro-cr326.types';

const PrimeiroCr326: React.FC<T.PrimeiroCr326Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCr326Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCr326Props>('audios')
      .where('estudo', '==', 'Estudo 326')
      .onSnapshot(snapshot => {
