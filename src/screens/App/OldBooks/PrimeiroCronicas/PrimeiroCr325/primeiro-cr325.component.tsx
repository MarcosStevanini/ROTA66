...
import * as S from './primeiro-cr325.styles';
import * as T from './primeiro-cr325.types';

const PrimeiroCr325: React.FC<T.PrimeiroCr325Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCr325Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCr325Props>('audios')
      .where('estudo', '==', 'Estudo 325')
      .onSnapshot(snapshot => {
