...
import * as S from './primeiro-cr324.styles';
import * as T from './primeiro-cr324.types';

const PrimeiroCr324: React.FC<T.PrimeiroCr324Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCr324Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCr324Props>('audios')
      .where('estudo', '==', 'Estudo 324')
      .onSnapshot(snapshot => {
