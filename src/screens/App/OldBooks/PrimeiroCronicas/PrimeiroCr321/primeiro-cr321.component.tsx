...
import * as S from './primeiro-cr321.styles';
import * as T from './primeiro-cr321.types';

const PrimeiroCr321: React.FC<T.PrimeiroCr321Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCr321Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCr321Props>('audios')
      .where('estudo', '==', 'Estudo 321')
      .onSnapshot(snapshot => {
