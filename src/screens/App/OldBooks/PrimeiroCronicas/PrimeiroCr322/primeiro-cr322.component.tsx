...
import * as S from './primeiro-cr322.styles';
import * as T from './primeiro-cr322.types';

const PrimeiroCr322: React.FC<T.PrimeiroCr322Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCr322Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCr322Props>('audios')
      .where('estudo', '==', 'Estudo 322')
      .onSnapshot(snapshot => {
