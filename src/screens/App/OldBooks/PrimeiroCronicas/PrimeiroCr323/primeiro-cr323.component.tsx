...
import * as S from './primeiro-cr323.styles';
import * as T from './primeiro-cr323.types';

const PrimeiroCr323: React.FC<T.PrimeiroCr323Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCr323Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCr323Props>('audios')
      .where('estudo', '==', 'Estudo 323')
      .onSnapshot(snapshot => {
