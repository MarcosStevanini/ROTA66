...
import * as S from './hb93.styles';
import * as T from './hb93.types';

const Hb93: React.FC<T.Hb93Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb93Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb93Props>('audios')
      .where('estudo', '==', 'Estudo 93')
      .onSnapshot(snapshot => {
