...
import * as S from './hb87.styles';
import * as T from './hb87.types';

const Hb87: React.FC<T.Hb87Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb87Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb87Props>('audios')
      .where('estudo', '==', 'Estudo 87')
      .onSnapshot(snapshot => {
