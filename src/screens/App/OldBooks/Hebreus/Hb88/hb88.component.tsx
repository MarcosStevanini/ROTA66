...
import * as S from './hb88.styles';
import * as T from './hb88.types';

const Hb88: React.FC<T.Hb88Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb88Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb88Props>('audios')
      .where('estudo', '==', 'Estudo 88')
      .onSnapshot(snapshot => {
