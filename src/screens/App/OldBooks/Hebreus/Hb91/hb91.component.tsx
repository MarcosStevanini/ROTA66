...
import * as S from './hb91.styles';
import * as T from './hb91.types';

const Hb91: React.FC<T.Hb91Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb91Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb91Props>('audios')
      .where('estudo', '==', 'Estudo 91')
      .onSnapshot(snapshot => {
