...
import * as S from './hb89.styles';
import * as T from './hb89.types';

const Hb89: React.FC<T.Hb89Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb89Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb89Props>('audios')
      .where('estudo', '==', 'Estudo 89')
      .onSnapshot(snapshot => {
