...
import * as S from './hb94.styles';
import * as T from './hb94.types';

const Hb94: React.FC<T.Hb94Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb94Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb94Props>('audios')
      .where('estudo', '==', 'Estudo 94')
      .onSnapshot(snapshot => {
