...
import * as S from './hb92.styles';
import * as T from './hb92.types';

const Hb92: React.FC<T.Hb92Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb92Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb92Props>('audios')
      .where('estudo', '==', 'Estudo 92')
      .onSnapshot(snapshot => {
