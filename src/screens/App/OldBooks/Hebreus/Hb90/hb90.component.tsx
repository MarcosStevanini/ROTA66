...
import * as S from './hb90.styles';
import * as T from './hb90.types';

const Hb90: React.FC<T.Hb90Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb90Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb90Props>('audios')
      .where('estudo', '==', 'Estudo 90')
      .onSnapshot(snapshot => {
