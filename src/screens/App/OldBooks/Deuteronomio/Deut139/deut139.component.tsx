...
import * as S from './deut139.styles';
import * as T from './deut139.types';

const Deut139: React.FC<T.Deut139Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut139Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut139Props>('audios')
      .where('estudo', '==', 'Estudo 139')
      .onSnapshot(snapshot => {
