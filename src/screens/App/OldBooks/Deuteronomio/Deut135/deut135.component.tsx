...
import * as S from './deut135.styles';
import * as T from './deut135.types';

const Deut135: React.FC<T.Deut135Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut135Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut135Props>('audios')
      .where('estudo', '==', 'Estudo 135')
      .onSnapshot(snapshot => {
