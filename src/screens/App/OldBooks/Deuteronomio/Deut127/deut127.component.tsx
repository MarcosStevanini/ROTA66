...
import * as S from './deut127.styles';
import * as T from './deut127.types';

const Deut127: React.FC<T.Deut127Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut127Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut127Props>('audios')
      .where('estudo', '==', 'Estudo 127')
      .onSnapshot(snapshot => {
