...
import * as S from './deut125.styles';
import * as T from './deut125.types';

const Deut125: React.FC<T.Deut125Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut125Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut125Props>('audios')
      .where('estudo', '==', 'Estudo 125')
      .onSnapshot(snapshot => {
