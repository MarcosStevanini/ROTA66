...
import * as S from './deut132.styles';
import * as T from './deut132.types';

const Deut132: React.FC<T.Deut132Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut132Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut132Props>('audios')
      .where('estudo', '==', 'Estudo 132')
      .onSnapshot(snapshot => {
