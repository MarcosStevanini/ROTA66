...
import * as S from './deut124.styles';
import * as T from './deut124.types';

const Deut124: React.FC<T.Deut124Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut124Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut124Props>('audios')
      .where('estudo', '==', 'Estudo 124')
      .onSnapshot(snapshot => {
