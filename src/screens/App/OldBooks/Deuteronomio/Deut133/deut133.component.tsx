...
import * as S from './deut133.styles';
import * as T from './deut133.types';

const Deut133: React.FC<T.Deut133Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut133Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut133Props>('audios')
      .where('estudo', '==', 'Estudo 133')
      .onSnapshot(snapshot => {
