...
import * as S from './deut122.styles';
import * as T from './deut122.types';

const Deut122: React.FC<T.Deut122Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut122Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut122Props>('audios')
      .where('estudo', '==', 'Estudo 122')
      .onSnapshot(snapshot => {
