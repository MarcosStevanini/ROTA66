...
import * as S from './deut128.styles';
import * as T from './deut128.types';

const Deut128: React.FC<T.Deut128Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut128Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut128Props>('audios')
      .where('estudo', '==', 'Estudo 128')
      .onSnapshot(snapshot => {
