...
import * as S from './deut123.styles';
import * as T from './deut123.types';

const Deut123: React.FC<T.Deut123Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut123Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut123Props>('audios')
      .where('estudo', '==', 'Estudo 123')
      .onSnapshot(snapshot => {
