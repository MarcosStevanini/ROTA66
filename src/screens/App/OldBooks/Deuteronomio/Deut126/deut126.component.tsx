...
import * as S from './deut126.styles';
import * as T from './deut126.types';

const Deut126: React.FC<T.Deut126Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut126Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut126Props>('audios')
      .where('estudo', '==', 'Estudo 126')
      .onSnapshot(snapshot => {
