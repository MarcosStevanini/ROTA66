...
import * as S from './deut131.styles';
import * as T from './deut131.types';

const Deut131: React.FC<T.Deut131Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut131Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut131Props>('audios')
      .where('estudo', '==', 'Estudo 131')
      .onSnapshot(snapshot => {
