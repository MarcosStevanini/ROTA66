...
import * as S from './deut130.styles';
import * as T from './deut130.types';

const Deut130: React.FC<T.Deut130Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut130Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut130Props>('audios')
      .where('estudo', '==', 'Estudo 130')
      .onSnapshot(snapshot => {
