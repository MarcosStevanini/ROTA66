...
import * as S from './deut136.styles';
import * as T from './deut136.types';

const Deut136: React.FC<T.Deut136Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut136Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut136Props>('audios')
      .where('estudo', '==', 'Estudo 136')
      .onSnapshot(snapshot => {
