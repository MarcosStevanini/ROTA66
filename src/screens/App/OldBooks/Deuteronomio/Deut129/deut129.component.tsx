...
import * as S from './deut129.styles';
import * as T from './deut129.types';

const Deut129: React.FC<T.Deut129Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut129Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut129Props>('audios')
      .where('estudo', '==', 'Estudo 129')
      .onSnapshot(snapshot => {
