...
import * as S from './deut137.styles';
import * as T from './deut137.types';

const Deut137: React.FC<T.Deut137Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut137Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut137Props>('audios')
      .where('estudo', '==', 'Estudo 137')
      .onSnapshot(snapshot => {
