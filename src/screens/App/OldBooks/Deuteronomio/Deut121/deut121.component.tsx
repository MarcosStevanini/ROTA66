...
import * as S from './deut121.styles';
import * as T from './deut121.types';

const Deut121: React.FC<T.Deut121Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut121Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut121Props>('audios')
      .where('estudo', '==', 'Estudo 121')
      .onSnapshot(snapshot => {
