...
import * as S from './deut138.styles';
import * as T from './deut138.types';

const Deut138: React.FC<T.Deut138Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut138Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut138Props>('audios')
      .where('estudo', '==', 'Estudo 138')
      .onSnapshot(snapshot => {
