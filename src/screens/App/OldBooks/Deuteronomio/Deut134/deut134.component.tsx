...
import * as S from './deut134.styles';
import * as T from './deut134.types';

const Deut134: React.FC<T.Deut134Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Deut134Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Deut134Props>('audios')
      .where('estudo', '==', 'Estudo 134')
      .onSnapshot(snapshot => {
