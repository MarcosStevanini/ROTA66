...
import * as S from './rom61.styles';
import * as T from './rom61.types';

const Rom61: React.FC<T.Rom61Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom61Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom61Props>('audios')
      .where('estudo', '==', 'Estudo 61')
      .onSnapshot(snapshot => {
