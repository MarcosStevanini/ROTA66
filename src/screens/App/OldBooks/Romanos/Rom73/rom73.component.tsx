...
import * as S from './rom73.styles';
import * as T from './rom73.types';

const Rom73: React.FC<T.Rom73Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom73Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom73Props>('audios')
      .where('estudo', '==', 'Estudo 73')
      .onSnapshot(snapshot => {
