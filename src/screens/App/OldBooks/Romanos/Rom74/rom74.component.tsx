...
import * as S from './rom74.styles';
import * as T from './rom74.types';

const Rom74: React.FC<T.Rom74Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom74Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom74Props>('audios')
      .where('estudo', '==', 'Estudo 74')
      .onSnapshot(snapshot => {
