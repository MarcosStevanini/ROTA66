...
import * as S from './rom62.styles';
import * as T from './rom62.types';

const Rom62: React.FC<T.Rom62Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom62Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom62Props>('audios')
      .where('estudo', '==', 'Estudo 62')
      .onSnapshot(snapshot => {
