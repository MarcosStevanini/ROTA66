...
import * as S from './rom68.styles';
import * as T from './rom68.types';

const Rom68: React.FC<T.Rom68Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom68Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom68Props>('audios')
      .where('estudo', '==', 'Estudo 68')
      .onSnapshot(snapshot => {
