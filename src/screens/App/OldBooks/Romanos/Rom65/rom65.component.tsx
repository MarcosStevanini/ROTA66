...
import * as S from './rom65.styles';
import * as T from './rom65.types';

const Rom65: React.FC<T.Rom65Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom65Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom65Props>('audios')
      .where('estudo', '==', 'Estudo 65')
      .onSnapshot(snapshot => {
