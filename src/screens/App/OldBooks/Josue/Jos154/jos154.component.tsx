...
import * as S from './jos154.styles';
import * as T from './jos154.types';

const Jos154: React.FC<T.Jos154Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos154Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos154Props>('audios')
      .where('estudo', '==', 'Estudo 154')
      .onSnapshot(snapshot => {
