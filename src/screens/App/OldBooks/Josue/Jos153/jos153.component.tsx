...
import * as S from './jos153.styles';
import * as T from './jos153.types';

const Jos153: React.FC<T.Jos153Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos153Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos153Props>('audios')
      .where('estudo', '==', 'Estudo 153')
      .onSnapshot(snapshot => {
