...
import * as S from './jos147.styles';
import * as T from './jos147.types';

const Jos147: React.FC<T.Jos147Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos147Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos147Props>('audios')
      .where('estudo', '==', 'Estudo 147')
      .onSnapshot(snapshot => {
