...
import * as S from './jos146.styles';
import * as T from './jos146.types';

const Jos146: React.FC<T.Jos146Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos146Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos146Props>('audios')
      .where('estudo', '==', 'Estudo 146')
      .onSnapshot(snapshot => {
