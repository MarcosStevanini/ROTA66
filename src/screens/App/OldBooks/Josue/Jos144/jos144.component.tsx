...
import * as S from './jos144.styles';
import * as T from './jos144.types';

const Jos144: React.FC<T.Jos144Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos144Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos144Props>('audios')
      .where('estudo', '==', 'Estudo 144')
      .onSnapshot(snapshot => {
