...
import * as S from './jos149.styles';
import * as T from './jos149.types';

const Jos149: React.FC<T.Jos149Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos149Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos149Props>('audios')
      .where('estudo', '==', 'Estudo 149')
      .onSnapshot(snapshot => {
