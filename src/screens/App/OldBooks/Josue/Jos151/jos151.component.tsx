...
import * as S from './jos151.styles';
import * as T from './jos151.types';

const Jos151: React.FC<T.Jos151Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos151Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos151Props>('audios')
      .where('estudo', '==', 'Estudo 151')
      .onSnapshot(snapshot => {
