...
import * as S from './jos145.styles';
import * as T from './jos145.types';

const Jos145: React.FC<T.Jos145Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos145Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos145Props>('audios')
      .where('estudo', '==', 'Estudo 145')
      .onSnapshot(snapshot => {
