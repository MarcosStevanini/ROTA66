...
import * as S from './jos150.styles';
import * as T from './jos150.types';

const Jos150: React.FC<T.Jos150Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos150Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos150Props>('audios')
      .where('estudo', '==', 'Estudo 150')
      .onSnapshot(snapshot => {
