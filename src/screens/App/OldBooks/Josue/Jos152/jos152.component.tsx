...
import * as S from './jos152.styles';
import * as T from './jos152.types';

const Jos152: React.FC<T.Jos152Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos152Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos152Props>('audios')
      .where('estudo', '==', 'Estudo 152')
      .onSnapshot(snapshot => {
