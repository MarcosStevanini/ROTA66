...
import * as S from './jos148.styles';
import * as T from './jos148.types';

const Jos148: React.FC<T.Jos148Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos148Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos148Props>('audios')
      .where('estudo', '==', 'Estudo 148')
      .onSnapshot(snapshot => {
