...
import * as S from './jos155.styles';
import * as T from './jos155.types';

const Jos155: React.FC<T.Jos155Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Jos155Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Jos155Props>('audios')
      .where('estudo', '==', 'Estudo 155')
      .onSnapshot(snapshot => {
