...
import * as S from './primeiro-re275.styles';
import * as T from './primeiro-re275.types';

const PrimeiroRe275: React.FC<T.PrimeiroRe275Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe275Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe275Props>('audios')
      .where('estudo', '==', 'Estudo 275')
      .onSnapshot(snapshot => {
