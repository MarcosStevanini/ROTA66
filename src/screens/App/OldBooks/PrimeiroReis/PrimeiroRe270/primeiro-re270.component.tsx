...
import * as S from './primeiro-re270.styles';
import * as T from './primeiro-re270.types';

const PrimeiroRe270: React.FC<T.PrimeiroRe270Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe270Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe270Props>('audios')
      .where('estudo', '==', 'Estudo 270')
      .onSnapshot(snapshot => {
