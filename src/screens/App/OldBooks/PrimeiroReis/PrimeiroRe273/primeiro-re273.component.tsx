...
import * as S from './primeiro-re273.styles';
import * as T from './primeiro-re273.types';

const PrimeiroRe273: React.FC<T.PrimeiroRe273Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe273Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe273Props>('audios')
      .where('estudo', '==', 'Estudo 273')
      .onSnapshot(snapshot => {
