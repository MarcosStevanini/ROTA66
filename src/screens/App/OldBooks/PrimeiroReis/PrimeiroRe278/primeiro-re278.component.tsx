...
import * as S from './primeiro-re278.styles';
import * as T from './primeiro-re278.types';

const PrimeiroRe278: React.FC<T.PrimeiroRe278Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe278Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe278Props>('audios')
      .where('estudo', '==', 'Estudo 278')
      .onSnapshot(snapshot => {
