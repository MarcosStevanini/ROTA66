...
import * as S from './primeiro-re268.styles';
import * as T from './primeiro-re268.types';

const PrimeiroRe268: React.FC<T.PrimeiroRe268Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe268Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe268Props>('audios')
      .where('estudo', '==', 'Estudo 268')
      .onSnapshot(snapshot => {
