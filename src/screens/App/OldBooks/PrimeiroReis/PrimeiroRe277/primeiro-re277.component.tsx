...
import * as S from './primeiro-re277.styles';
import * as T from './primeiro-re277.types';

const PrimeiroRe277: React.FC<T.PrimeiroRe277Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe277Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe277Props>('audios')
      .where('estudo', '==', 'Estudo 277')
      .onSnapshot(snapshot => {
