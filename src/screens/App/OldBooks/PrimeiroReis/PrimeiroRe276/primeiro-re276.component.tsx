...
import * as S from './primeiro-re276.styles';
import * as T from './primeiro-re276.types';

const PrimeiroRe276: React.FC<T.PrimeiroRe276Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe276Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe276Props>('audios')
      .where('estudo', '==', 'Estudo 276')
      .onSnapshot(snapshot => {
