...
import * as S from './primeiro-re274.styles';
import * as T from './primeiro-re274.types';

const PrimeiroRe274: React.FC<T.PrimeiroRe274Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe274Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe274Props>('audios')
      .where('estudo', '==', 'Estudo 274')
      .onSnapshot(snapshot => {
