...
import * as S from './primeiro-re267.styles';
import * as T from './primeiro-re267.types';

const PrimeiroRe267: React.FC<T.PrimeiroRe267Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe267Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe267Props>('audios')
      .where('estudo', '==', 'Estudo 267')
      .onSnapshot(snapshot => {
