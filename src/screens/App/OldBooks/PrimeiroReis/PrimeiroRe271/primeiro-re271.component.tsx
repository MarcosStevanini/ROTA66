...
import * as S from './primeiro-re271.styles';
import * as T from './primeiro-re271.types';

const PrimeiroRe271: React.FC<T.PrimeiroRe271Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe271Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe271Props>('audios')
      .where('estudo', '==', 'Estudo 271')
      .onSnapshot(snapshot => {
