...
import * as S from './primeiro-re269.styles';
import * as T from './primeiro-re269.types';

const PrimeiroRe269: React.FC<T.PrimeiroRe269Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe269Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe269Props>('audios')
      .where('estudo', '==', 'Estudo 269')
      .onSnapshot(snapshot => {
