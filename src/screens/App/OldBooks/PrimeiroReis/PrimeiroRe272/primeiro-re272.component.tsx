...
import * as S from './primeiro-re272.styles';
import * as T from './primeiro-re272.types';

const PrimeiroRe272: React.FC<T.PrimeiroRe272Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroRe272Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroRe272Props>('audios')
      .where('estudo', '==', 'Estudo 272')
      .onSnapshot(snapshot => {
