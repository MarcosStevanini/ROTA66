...
import * as S from './segundo-re280.styles';
import * as T from './segundo-re280.types';

const SegundoRe280: React.FC<T.SegundoRe280Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoRe280Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoRe280Props>('audios')
      .where('estudo', '==', 'Estudo 280')
      .onSnapshot(snapshot => {
