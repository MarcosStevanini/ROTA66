...
import * as S from './segundo-re288.styles';
import * as T from './segundo-re288.types';

const SegundoRe288: React.FC<T.SegundoRe288Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoRe288Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoRe288Props>('audios')
      .where('estudo', '==', 'Estudo 288')
      .onSnapshot(snapshot => {
