...
import * as S from './segundo-re285.styles';
import * as T from './segundo-re285.types';

const SegundoRe285: React.FC<T.SegundoRe285Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoRe285Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoRe285Props>('audios')
      .where('estudo', '==', 'Estudo 285')
      .onSnapshot(snapshot => {
