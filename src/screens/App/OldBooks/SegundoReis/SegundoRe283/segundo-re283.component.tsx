...
import * as S from './segundo-re283.styles';
import * as T from './segundo-re283.types';

const SegundoRe283: React.FC<T.SegundoRe283Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoRe283Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoRe283Props>('audios')
      .where('estudo', '==', 'Estudo 283')
      .onSnapshot(snapshot => {
