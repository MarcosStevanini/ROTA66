...
import * as S from './segundo-re281.styles';
import * as T from './segundo-re281.types';

const SegundoRe281: React.FC<T.SegundoRe281Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoRe281Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoRe281Props>('audios')
      .where('estudo', '==', 'Estudo 281')
      .onSnapshot(snapshot => {
