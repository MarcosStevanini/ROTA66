...
import * as S from './segundo-re284.styles';
import * as T from './segundo-re284.types';

const SegundoRe284: React.FC<T.SegundoRe284Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoRe284Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoRe284Props>('audios')
      .where('estudo', '==', 'Estudo 284')
      .onSnapshot(snapshot => {
