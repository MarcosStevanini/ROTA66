...
import * as S from './segundo-re286.styles';
import * as T from './segundo-re286.types';

const SegundoRe286: React.FC<T.SegundoRe286Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoRe286Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoRe286Props>('audios')
      .where('estudo', '==', 'Estudo 286')
      .onSnapshot(snapshot => {
