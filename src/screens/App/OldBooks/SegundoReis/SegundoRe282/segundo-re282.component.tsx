...
import * as S from './segundo-re282.styles';
import * as T from './segundo-re282.types';

const SegundoRe282: React.FC<T.SegundoRe282Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoRe282Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoRe282Props>('audios')
      .where('estudo', '==', 'Estudo 282')
      .onSnapshot(snapshot => {
