...
import * as S from './segundo-re287.styles';
import * as T from './segundo-re287.types';

const SegundoRe287: React.FC<T.SegundoRe287Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoRe287Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoRe287Props>('audios')
      .where('estudo', '==', 'Estudo 287')
      .onSnapshot(snapshot => {
