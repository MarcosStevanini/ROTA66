...
import * as S from './segundo-re279.styles';
import * as T from './segundo-re279.types';

const SegundoRe279: React.FC<T.SegundoRe279Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoRe279Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoRe279Props>('audios')
      .where('estudo', '==', 'Estudo 279')
      .onSnapshot(snapshot => {
