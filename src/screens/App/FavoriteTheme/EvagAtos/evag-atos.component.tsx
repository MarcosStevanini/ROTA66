...
import * as S from './evag-atos.styles';
import * as T from './evag-atos.types';

const EvagAtos: React.FC<T.EvagAtosProps> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.EvagAtosProps[]>([])
