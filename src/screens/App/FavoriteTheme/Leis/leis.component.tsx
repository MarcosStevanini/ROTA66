...
import * as S from './leis.styles';
import * as T from './leis.types';

const Leis: React.FC<T.LeisProps> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.LeisProps[]>([])
