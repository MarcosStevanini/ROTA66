...
import * as S from './poeticos.styles';
import * as T from './poeticos.types';

const Poeticos: React.FC<T.PoeticosProps> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PoeticosProps[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PoeticosProps>('audios')
      .where('tema', '==', 'Poeticos')
      .onSnapshot(snapshot => {
