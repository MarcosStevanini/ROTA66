...
import * as S from './profet.styles';
import * as T from './profet.types';

const Profet: React.FC<T.ProfetProps> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.ProfetProps[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.ProfetProps>('audios')
      .where('tema', '==', 'Profeticos')
      .onSnapshot(snapshot => {
