...
import * as S from './rom63.styles';
import * as T from './rom63.types';

const Rom63: React.FC<T.Rom63Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom63Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom63Props>('audios')
      .where('estudo', '==', 'Estudo 63')
      .onSnapshot(snapshot => {
