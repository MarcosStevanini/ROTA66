...
import * as S from './rom71.styles';
import * as T from './rom71.types';

const Rom71: React.FC<T.Rom71Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom71Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom71Props>('audios')
      .where('estudo', '==', 'Estudo 71')
      .onSnapshot(snapshot => {
