...
import * as S from './rom66.styles';
import * as T from './rom66.types';

const Rom66: React.FC<T.Rom66Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom66Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom66Props>('audios')
      .where('estudo', '==', 'Estudo 66')
      .onSnapshot(snapshot => {
