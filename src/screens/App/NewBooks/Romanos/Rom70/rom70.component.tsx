...
import * as S from './rom70.styles';
import * as T from './rom70.types';

const Rom70: React.FC<T.Rom70Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom70Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom70Props>('audios')
      .where('estudo', '==', 'Estudo 70')
      .onSnapshot(snapshot => {
