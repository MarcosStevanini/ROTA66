...
import * as S from './rom72.styles';
import * as T from './rom72.types';

const Rom72: React.FC<T.Rom72Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom72Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom72Props>('audios')
      .where('estudo', '==', 'Estudo 72')
      .onSnapshot(snapshot => {
