...
import * as S from './rom64.styles';
import * as T from './rom64.types';

const Rom64: React.FC<T.Rom64Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom64Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom64Props>('audios')
      .where('estudo', '==', 'Estudo 64')
      .onSnapshot(snapshot => {
