...
import * as S from './rom67.styles';
import * as T from './rom67.types';

const Rom67: React.FC<T.Rom67Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom67Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom67Props>('audios')
      .where('estudo', '==', 'Estudo 67')
      .onSnapshot(snapshot => {
