...
import * as S from './rom69.styles';
import * as T from './rom69.types';

const Rom69: React.FC<T.Rom69Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Rom69Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Rom69Props>('audios')
      .where('estudo', '==', 'Estudo 69')
      .onSnapshot(snapshot => {
