...
import * as S from './hb98.styles';
import * as T from './hb98.types';

const Hb98: React.FC<T.Hb98Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb98Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb98Props>('audios')
      .where('estudo', '==', 'Estudo 98')
      .onSnapshot(snapshot => {
