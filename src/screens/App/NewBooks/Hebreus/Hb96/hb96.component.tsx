...
import * as S from './hb96.styles';
import * as T from './hb96.types';

const Hb96: React.FC<T.Hb96Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb96Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb96Props>('audios')
      .where('estudo', '==', 'Estudo 96')
      .onSnapshot(snapshot => {
