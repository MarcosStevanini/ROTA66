...
import * as S from './hb95.styles';
import * as T from './hb95.types';

const Hb95: React.FC<T.Hb95Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb95Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb95Props>('audios')
      .where('estudo', '==', 'Estudo 95')
      .onSnapshot(snapshot => {
