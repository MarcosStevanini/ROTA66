...
import * as S from './hb97.styles';
import * as T from './hb97.types';

const Hb97: React.FC<T.Hb97Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Hb97Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Hb97Props>('audios')
      .where('estudo', '==', 'Estudo 97')
      .onSnapshot(snapshot => {
