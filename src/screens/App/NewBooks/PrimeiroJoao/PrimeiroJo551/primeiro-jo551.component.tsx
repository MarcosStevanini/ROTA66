...
import * as S from './primeiro-jo551.styles';
import * as T from './primeiro-jo551.types';

const PrimeiroJo551: React.FC<T.PrimeiroJo551Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroJo551Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroJo551Props>('audios')
      .where('estudo', '==', 'Estudo 551')
      .onSnapshot(snapshot => {
