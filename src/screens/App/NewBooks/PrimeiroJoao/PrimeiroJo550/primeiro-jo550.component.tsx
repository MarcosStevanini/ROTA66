...
import * as S from './primeiro-jo550.styles';
import * as T from './primeiro-jo550.types';

const PrimeiroJo550: React.FC<T.PrimeiroJo550Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroJo550Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroJo550Props>('audios')
      .where('estudo', '==', 'Estudo 550')
      .onSnapshot(snapshot => {
