...
import * as S from './primeiro-jo553.styles';
import * as T from './primeiro-jo553.types';

const PrimeiroJo553: React.FC<T.PrimeiroJo553Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroJo553Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroJo553Props>('audios')
      .where('estudo', '==', 'Estudo 553')
      .onSnapshot(snapshot => {
