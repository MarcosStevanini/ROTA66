...
import * as S from './primeiro-jo552.styles';
import * as T from './primeiro-jo552.types';

const PrimeiroJo552: React.FC<T.PrimeiroJo552Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroJo552Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroJo552Props>('audios')
      .where('estudo', '==', 'Estudo 552')
      .onSnapshot(snapshot => {
