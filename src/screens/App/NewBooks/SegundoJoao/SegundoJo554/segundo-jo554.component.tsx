...
import * as S from './segundo-jo554.styles';
import * as T from './segundo-jo554.types';

const SegundoJo554: React.FC<T.SegundoJo554Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoJo554Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoJo554Props>('audios')
      .where('estudo', '==', 'Estudo 554')
      .onSnapshot(snapshot => {
