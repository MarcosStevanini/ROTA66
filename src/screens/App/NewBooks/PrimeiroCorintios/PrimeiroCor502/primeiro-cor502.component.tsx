...
import * as S from './primeiro-cor502.styles';
import * as T from './primeiro-cor502.types';

const PrimeiroCor502: React.FC<T.PrimeiroCor502Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor502Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor502Props>('audios')
      .where('estudo', '==', 'Estudo 502')
      .onSnapshot(snapshot => {
