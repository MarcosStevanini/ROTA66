...
import * as S from './primeiro-cor492.styles';
import * as T from './primeiro-cor492.types';

const PrimeiroCor492: React.FC<T.PrimeiroCor492Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor492Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor492Props>('audios')
      .where('estudo', '==', 'Estudo 492')
      .onSnapshot(snapshot => {
