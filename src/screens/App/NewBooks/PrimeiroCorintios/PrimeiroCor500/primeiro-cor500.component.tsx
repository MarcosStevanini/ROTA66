...
import * as S from './primeiro-cor500.styles';
import * as T from './primeiro-cor500.types';

const PrimeiroCor500: React.FC<T.PrimeiroCor500Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor500Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor500Props>('audios')
      .where('estudo', '==', 'Estudo 500')
      .onSnapshot(snapshot => {
