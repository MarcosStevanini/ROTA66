...
import * as S from './primeiro-cor497.styles';
import * as T from './primeiro-cor497.types';

const PrimeiroCor497: React.FC<T.PrimeiroCor497Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor497Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor497Props>('audios')
      .where('estudo', '==', 'Estudo 497')
      .onSnapshot(snapshot => {
