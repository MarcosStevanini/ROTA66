...
import * as S from './primeiro-cor494.styles';
import * as T from './primeiro-cor494.types';

const PrimeiroCor494: React.FC<T.PrimeiroCor494Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor494Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor494Props>('audios')
      .where('estudo', '==', 'Estudo 494')
      .onSnapshot(snapshot => {
