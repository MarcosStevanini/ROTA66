...
import * as S from './primeiro-cor498.styles';
import * as T from './primeiro-cor498.types';

const PrimeiroCor498: React.FC<T.PrimeiroCor498Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor498Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor498Props>('audios')
      .where('estudo', '==', 'Estudo 498')
      .onSnapshot(snapshot => {
