...
import * as S from './primeiro-cor496.styles';
import * as T from './primeiro-cor496.types';

const PrimeiroCor496: React.FC<T.PrimeiroCor496Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor496Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor496Props>('audios')
      .where('estudo', '==', 'Estudo 496')
      .onSnapshot(snapshot => {
