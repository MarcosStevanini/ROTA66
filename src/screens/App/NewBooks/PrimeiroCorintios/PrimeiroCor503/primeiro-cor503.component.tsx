...
import * as S from './primeiro-cor503.styles';
import * as T from './primeiro-cor503.types';

const PrimeiroCor503: React.FC<T.PrimeiroCor503Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor503Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor503Props>('audios')
      .where('estudo', '==', 'Estudo 503')
      .onSnapshot(snapshot => {
