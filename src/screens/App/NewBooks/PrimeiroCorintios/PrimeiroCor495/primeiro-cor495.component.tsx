...
import * as S from './primeiro-cor495.styles';
import * as T from './primeiro-cor495.types';

const PrimeiroCor495: React.FC<T.PrimeiroCor495Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor495Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor495Props>('audios')
      .where('estudo', '==', 'Estudo 495')
      .onSnapshot(snapshot => {
