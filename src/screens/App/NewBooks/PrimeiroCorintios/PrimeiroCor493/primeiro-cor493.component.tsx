...
import * as S from './primeiro-cor493.styles';
import * as T from './primeiro-cor493.types';

const PrimeiroCor493: React.FC<T.PrimeiroCor493Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor493Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor493Props>('audios')
      .where('estudo', '==', 'Estudo 493')
      .onSnapshot(snapshot => {
