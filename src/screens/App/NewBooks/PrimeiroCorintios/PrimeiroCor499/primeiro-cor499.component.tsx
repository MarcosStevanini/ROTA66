...
import * as S from './primeiro-cor499.styles';
import * as T from './primeiro-cor499.types';

const PrimeiroCor499: React.FC<T.PrimeiroCor499Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor499Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor499Props>('audios')
      .where('estudo', '==', 'Estudo 499')
      .onSnapshot(snapshot => {
