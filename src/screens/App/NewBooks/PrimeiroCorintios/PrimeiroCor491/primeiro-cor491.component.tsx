...
import * as S from './primeiro-cor491.styles';
import * as T from './primeiro-cor491.types';

const PrimeiroCor491: React.FC<T.PrimeiroCor491Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor491Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor491Props>('audios')
      .where('estudo', '==', 'Estudo 491')
      .onSnapshot(snapshot => {
