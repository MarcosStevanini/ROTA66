...
import * as S from './primeiro-cor501.styles';
import * as T from './primeiro-cor501.types';

const PrimeiroCor501: React.FC<T.PrimeiroCor501Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroCor501Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroCor501Props>('audios')
      .where('estudo', '==', 'Estudo 501')
      .onSnapshot(snapshot => {
