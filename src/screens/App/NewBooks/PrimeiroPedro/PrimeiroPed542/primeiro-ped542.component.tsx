...
import * as S from './primeiro-ped542.styles';
import * as T from './primeiro-ped542.types';

const PrimeiroPed542: React.FC<T.PrimeiroPed542Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroPed542Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroPed542Props>('audios')
      .where('estudo', '==', 'Estudo 542')
      .onSnapshot(snapshot => {
