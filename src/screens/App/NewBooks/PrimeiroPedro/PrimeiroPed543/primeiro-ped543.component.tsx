...
import * as S from './primeiro-ped543.styles';
import * as T from './primeiro-ped543.types';

const PrimeiroPed543: React.FC<T.PrimeiroPed543Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroPed543Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroPed543Props>('audios')
      .where('estudo', '==', 'Estudo 543')
      .onSnapshot(snapshot => {
