...
import * as S from './primeiro-ped545.styles';
import * as T from './primeiro-ped545.types';

const PrimeiroPed545: React.FC<T.PrimeiroPed545Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroPed545Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroPed545Props>('audios')
      .where('estudo', '==', 'Estudo 545')
      .onSnapshot(snapshot => {
