...
import * as S from './primeiro-ped544.styles';
import * as T from './primeiro-ped544.types';

const PrimeiroPed544: React.FC<T.PrimeiroPed544Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroPed544Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroPed544Props>('audios')
      .where('estudo', '==', 'Estudo 544')
      .onSnapshot(snapshot => {
