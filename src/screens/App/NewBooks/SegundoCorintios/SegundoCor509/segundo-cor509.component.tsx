...
import * as S from './segundo-cor509.styles';
import * as T from './segundo-cor509.types';

const SegundoCor509: React.FC<T.SegundoCor509Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCor509Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCor509Props>('audios')
      .where('estudo', '==', 'Estudo 509')
      .onSnapshot(snapshot => {
