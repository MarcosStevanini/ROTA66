...
import * as S from './segundo-cor510.styles';
import * as T from './segundo-cor510.types';

const SegundoCor510: React.FC<T.SegundoCor510Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCor510Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCor510Props>('audios')
      .where('estudo', '==', 'Estudo 510')
      .onSnapshot(snapshot => {
