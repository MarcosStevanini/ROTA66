...
import * as S from './segundo-cor507.styles';
import * as T from './segundo-cor507.types';

const SegundoCor507: React.FC<T.SegundoCor507Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCor507Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCor507Props>('audios')
      .where('estudo', '==', 'Estudo 507')
      .onSnapshot(snapshot => {
