...
import * as S from './segundo-cor505.styles';
import * as T from './segundo-cor505.types';

const SegundoCor505: React.FC<T.SegundoCor505Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCor505Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCor505Props>('audios')
      .where('estudo', '==', 'Estudo 505')
      .onSnapshot(snapshot => {
