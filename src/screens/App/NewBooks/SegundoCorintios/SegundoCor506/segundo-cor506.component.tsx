...
import * as S from './segundo-cor506.styles';
import * as T from './segundo-cor506.types';

const SegundoCor506: React.FC<T.SegundoCor506Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCor506Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCor506Props>('audios')
      .where('estudo', '==', 'Estudo 506')
      .onSnapshot(snapshot => {
