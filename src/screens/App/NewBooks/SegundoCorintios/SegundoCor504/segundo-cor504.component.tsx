...
import * as S from './segundo-cor504.styles';
import * as T from './segundo-cor504.types';

const SegundoCor504: React.FC<T.SegundoCor504Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCor504Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCor504Props>('audios')
      .where('estudo', '==', 'Estudo 504')
      .onSnapshot(snapshot => {
