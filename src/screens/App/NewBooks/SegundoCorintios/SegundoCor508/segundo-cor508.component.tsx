...
import * as S from './segundo-cor508.styles';
import * as T from './segundo-cor508.types';

const SegundoCor508: React.FC<T.SegundoCor508Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoCor508Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoCor508Props>('audios')
      .where('estudo', '==', 'Estudo 508')
      .onSnapshot(snapshot => {
