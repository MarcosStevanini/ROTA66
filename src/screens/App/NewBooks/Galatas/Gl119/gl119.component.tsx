...
import * as S from './gl119.styles';
import * as T from './gl119.types';

const Gl119: React.FC<T.Gl119Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Gl119Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Gl119Props>('audios')
      .where('estudo', '==', 'Estudo 119')
      .onSnapshot(snapshot => {
