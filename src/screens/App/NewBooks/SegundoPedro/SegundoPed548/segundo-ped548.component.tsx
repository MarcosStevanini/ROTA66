...
import * as S from './segundo-ped548.styles';
import * as T from './segundo-ped548.types';

const SegundoPed548: React.FC<T.SegundoPed548Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoPed548Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoPed548Props>('audios')
      .where('estudo', '==', 'Estudo 548')
      .onSnapshot(snapshot => {
