...
import * as S from './segundo-ped547.styles';
import * as T from './segundo-ped547.types';

const SegundoPed547: React.FC<T.SegundoPed547Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoPed547Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoPed547Props>('audios')
      .where('estudo', '==', 'Estudo 547')
      .onSnapshot(snapshot => {
