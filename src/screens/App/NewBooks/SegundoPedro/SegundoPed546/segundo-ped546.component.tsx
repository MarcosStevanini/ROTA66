...
import * as S from './segundo-ped546.styles';
import * as T from './segundo-ped546.types';

const SegundoPed546: React.FC<T.SegundoPed546Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoPed546Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoPed546Props>('audios')
      .where('estudo', '==', 'Estudo 546')
      .onSnapshot(snapshot => {
