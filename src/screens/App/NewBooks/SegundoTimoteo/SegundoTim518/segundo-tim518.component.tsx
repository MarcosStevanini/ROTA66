...
import * as S from './segundo-tim518.styles';
import * as T from './segundo-tim518.types';

const SegundoTim518: React.FC<T.SegundoTim518Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoTim518Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoTim518Props>('audios')
      .where('estudo', '==', 'Estudo 518')
      .onSnapshot(snapshot => {
