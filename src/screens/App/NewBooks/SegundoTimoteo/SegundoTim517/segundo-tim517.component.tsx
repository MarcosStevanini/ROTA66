...
import * as S from './segundo-tim517.styles';
import * as T from './segundo-tim517.types';

const SegundoTim517: React.FC<T.SegundoTim517Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoTim517Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoTim517Props>('audios')
      .where('estudo', '==', 'Estudo 517')
      .onSnapshot(snapshot => {
