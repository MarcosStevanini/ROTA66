...
import * as S from './segundo-tim519.styles';
import * as T from './segundo-tim519.types';

const SegundoTim519: React.FC<T.SegundoTim519Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoTim519Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoTim519Props>('audios')
      .where('estudo', '==', 'Estudo 519')
      .onSnapshot(snapshot => {
