...
import * as S from './terceiro-jo555.styles';
import * as T from './terceiro-jo555.types';

const TerceiroJo555: React.FC<T.TerceiroJo555Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.TerceiroJo555Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.TerceiroJo555Props>('audios')
      .where('estudo', '==', 'Estudo 555')
      .onSnapshot(snapshot => {
