...
import * as S from './tg140.styles';
import * as T from './tg140.types';

const Tg140: React.FC<T.Tg140Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Tg140Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Tg140Props>('audios')
      .where('estudo', '==', 'Estudo 140')
      .onSnapshot(snapshot => {
