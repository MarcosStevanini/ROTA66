...
import * as S from './tg142.styles';
import * as T from './tg142.types';

const Tg142: React.FC<T.Tg142Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Tg142Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Tg142Props>('audios')
      .where('estudo', '==', 'Estudo 142')
      .onSnapshot(snapshot => {
