...
import * as S from './segundo-tess525.styles';
import * as T from './segundo-tess525.types';

const SegundoTess525: React.FC<T.SegundoTess525Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoTess525Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoTess525Props>('audios')
      .where('estudo', '==', 'Estudo 525')
      .onSnapshot(snapshot => {
