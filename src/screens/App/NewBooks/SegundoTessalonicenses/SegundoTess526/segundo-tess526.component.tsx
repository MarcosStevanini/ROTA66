...
import * as S from './segundo-tess526.styles';
import * as T from './segundo-tess526.types';

const SegundoTess526: React.FC<T.SegundoTess526Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoTess526Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoTess526Props>('audios')
      .where('estudo', '==', 'Estudo 526')
      .onSnapshot(snapshot => {
