...
import * as S from './segundo-tess527.styles';
import * as T from './segundo-tess527.types';

const SegundoTess527: React.FC<T.SegundoTess527Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.SegundoTess527Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.SegundoTess527Props>('audios')
      .where('estudo', '==', 'Estudo 527')
      .onSnapshot(snapshot => {
