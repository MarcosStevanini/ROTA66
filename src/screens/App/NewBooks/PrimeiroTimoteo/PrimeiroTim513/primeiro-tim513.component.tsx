...
import * as S from './primeiro-tim513.styles';
import * as T from './primeiro-tim513.types';

const PrimeiroTim513: React.FC<T.PrimeiroTim513Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroTim513Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroTim513Props>('audios')
      .where('estudo', '==', 'Estudo 513')
      .onSnapshot(snapshot => {
