...
import * as S from './primeiro-tim514.styles';
import * as T from './primeiro-tim514.types';

const PrimeiroTim514: React.FC<T.PrimeiroTim514Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroTim514Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroTim514Props>('audios')
      .where('estudo', '==', 'Estudo 514')
      .onSnapshot(snapshot => {
