...
import * as S from './primeiro-tim511.styles';
import * as T from './primeiro-tim511.types';

const PrimeiroTim511: React.FC<T.PrimeiroTim511Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroTim511Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroTim511Props>('audios')
      .where('estudo', '==', 'Estudo 511')
      .onSnapshot(snapshot => {
