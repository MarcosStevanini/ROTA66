...
import * as S from './primeiro-tim515.styles';
import * as T from './primeiro-tim515.types';

const PrimeiroTim515: React.FC<T.PrimeiroTim515Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroTim515Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroTim515Props>('audios')
      .where('estudo', '==', 'Estudo 515')
      .onSnapshot(snapshot => {
