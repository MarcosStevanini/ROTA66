...
import * as S from './primeiro-tim512.styles';
import * as T from './primeiro-tim512.types';

const PrimeiroTim512: React.FC<T.PrimeiroTim512Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroTim512Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroTim512Props>('audios')
      .where('estudo', '==', 'Estudo 512')
      .onSnapshot(snapshot => {
