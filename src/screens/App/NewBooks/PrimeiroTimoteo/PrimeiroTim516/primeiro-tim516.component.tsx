...
import * as S from './primeiro-tim516.styles';
import * as T from './primeiro-tim516.types';

const PrimeiroTim516: React.FC<T.PrimeiroTim516Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.PrimeiroTim516Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.PrimeiroTim516Props>('audios')
      .where('estudo', '==', 'Estudo 516')
      .onSnapshot(snapshot => {
