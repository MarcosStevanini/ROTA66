...
import * as S from './filip538.styles';
import * as T from './filip538.types';

const Filip538: React.FC<T.Filip538Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Filip538Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Filip538Props>('audios')
      .where('estudo', '==', 'Estudo 538')
      .onSnapshot(snapshot => {
