...
import * as S from './filip539.styles';
import * as T from './filip539.types';

const Filip539: React.FC<T.Filip539Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Filip539Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Filip539Props>('audios')
      .where('estudo', '==', 'Estudo 539')
      .onSnapshot(snapshot => {
