...
import * as S from './filip541.styles'
import * as T from './filip541.types'

const Filip541: React.FC<T.Filip541Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Filip541Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Filip541Props>('audios')
      .where('estudo', '==', 'Estudo 541')
      .onSnapshot(snapshot => {
