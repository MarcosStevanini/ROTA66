...
import * as S from './filip540.styles';
import * as T from './filip540.types';

const Filip540: React.FC<T.Filip540Props> = () => {
  const [isLoading, setIsLoading] = useState(false)
  const [audio, setAudio] = useState<T.Filip540Props[]>([])
  ...
  useEffect(() => {
    ...
    const subscribe = firestore()
      .collection<T.Filip540Props>('audios')
      .where('estudo', '==', 'Estudo 540')
      .onSnapshot(snapshot => {
